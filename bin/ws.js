...
var serverNameList = ["Lime","Zomp","Wine","Volt","Teal","Soap","Snow","Sand","Sage","Rust","Aqua","Ruby","Rose","Puce","Plum","Pink","Peru","Pear","Onyx","Navy","Mint","Ming","Lust","Lion","Aero","Lava","Kobi","Kobe","Kiwi","Jade","Iris","Gray","Gold","Blue","Flax","Fawn","Ecru","Drab","Bole","Bone","Dirt","Deer","Cyan","Corn","Ceil","Buff","Peach","Melon","Cadet","Camel","Capri","Wheat","Wenge","Umber","Tulip","Topaz","Taupe","Sunny","Straw","Smoke","Smalt","Coral","Brown","Sepia","Cream","Amber","Ruddy","Ruber","Rajah","Prune","Phlox","Pearl","White","Peach","Olive","Ochre","Denim","Brass","Blush","Azure","Ebony","Mauve","Maize","Livid","Liver","Linen","Lilac","Lemon","Flame","Beige","Flirt","Folly","Khaki","Ivory","Green","Blond","Black","Grape","Cherry","Auburn","Sunray","Almond","Violet","Stizza","Orchid","Amazon","Canary","Citron","Desert","Desire","Nyanza","Nickel","Claret","UA-red","Coffee","Silver","Mystic","Copper","Maroon","Mantis","Tuscan","Lumber","Fallow","Sienna","Shadow","Cerise","Bazaar","Zaffre","Yellow","CG-Red","Beaver","Salmon","Bronze","Russet","Rufous","Keppel","Jasper","Bisque","Tomato","Bistre","Ginger","Indigo","Grullo","Xanadu","Rhythm","Sunset","Quartz","Redwood","Carmine","Iceberg","Gamboge","Fulvous","Jasmine","Fuchsia","Jonquil","Begonia","Kobicha","Liberty","Magenta","Manatee","Emerald","Mindaro","Mustard","New-Car","Diamond","Olivine","Awesome","Avocado","Peridot","Grizzly","Popstar","Pumpkin","Rackley","Glitter","Regalia","Arsenic","Apricot","Saffron","Crimson","Sangria","Scarlet","Scarlet","Shampoo","Sinopia","Coconut","Smitten","Citrine","Sunglow","Tangelo","Thistle","Toolbox","CG-Blue","Celeste","Tuscany","UA-blue","Celadon","Bubbles","Vanilla","Catawba","Platinum","Icterine","Deep-Red","Flattery","Dark-tan","Imperial","Aureolin","Dark-red","Licorice","Inchworm","Ash-grey","GO-green","Feldspar","Feldgrau","Limerick","Barn-red","Rose-red","Rosewood","Fandango","Ruby-red","Daffodil","Cyclamen","Falu-red","Glaucous","Amethyst","Cultured","Magnolia","Mahogany","Sapphire","Eminence","Gunmetal","Sea-blue","Seashell","Cornsilk","Cordovan","Mandarin","Han-blue","Sky-blue","Marigold","Eggshell","Eggplant","Cinnamon","Cinnabar","Burgundy","Chestnut","Charcoal","Midnight","Tea-rose","Tea-rose","Amaranth","Honeydew","Moccasin","Mulberry","Cerulean","Hot-pink","Puce-red","Dim-gray","June-bud","Old-gold","Urobilin","USC-Gold","Old-lace","Veronica","Old-rose","Viridian","Key-Lime","Cardinal","Wisteria","Dark-cyan","Artichoke","Rose-Dust","Rose-gold","Rose-pink","Blueberry","Rose-vale","Duke-blue","Dark-blue","Gainsboro","Frostbite","Dandelion","Malachite","Brick-red","Ogre-Odor","Rusty-red","Heat-Wave","Aero-blue","Old-mauve","Fresh-Air","Sand-dune","Sandstorm","Sandy-Tan","Deep-ruby","Sap-green","Blue-Bell","Blue-Bolt","Goldenrod","Pale-aqua","Sea-green","Pale-blue","Pale-cyan","Pale-gold","Pale-pink","Coral-red","Cool-grey","Pale-plum","Skobeloff","Palm-Leaf","Patriarch","Deep-puce","Deep-pink","Amazonite","Mauvelous","Spicy-mix","May-green","Cinereous","Maya-blue","Chocolate","Persimmon","Infra-Red","Harlequin","Tangerine","Champagne","Tea-green","Pineapple","Dark-puce","Pink-lace","Teal-blue","Teal-deer","Pistachio","Chamoisee","Mimi-Pink","Asparagus","True-Blue","Eton-blue","Turquoise","Dark-pink","Baby-pink","Baby-blue","Ball-blue","UCLA-Blue","UCLA-Gold","UFO-Green","Ultra-red","Purpureus","UP-Maroon","Dark-lava","MSU-Green","Dark-gray","Verdigris","Vermilion","Vermilion","Raspberry","Raw-umber","Red-devil","Vivid-red","Carnelian","Red-Salsa","Beau-blue","Byzantium","Alabaster","Firebrick","Byzantine","Yale-Blue","Burlywood","Bud-green","Rose-ebony","Cameo-pink","Meat-brown","Heliotrope","Rose-taupe","Middle-Red","Charm-pink","Rosy-brown","Royal-blue","Royal-blue","Chartreuse","Rubine-red","Dust-storm","Brink-pink","Candy-pink","Ruddy-pink","Mint-cream","Mint-green","Misty-Moss","Misty-rose","China-pink","Mode-beige","Moss-green","Indian-red","Cyan-azure","Indigo-dye","China-rose","Aztec-Gold","Neon-green","Isabelline","Blue-Jeans","Eucalyptus","Ocean-Blue","Bubble-gum","Seal-brown","Dark-brown","Jelly-Bean","Dark-coral","Jordy-blue","Acid-green","Old-silver","Bluebonnet","Olive-Drab","Dark-green","Slate-blue","Slate-gray","Fern-green","Field-drab","Fiery-Rose","Dark-khaki","Pale-brown","Solid-pink","Azure-mist","Spring-bud","Steel-blue","Steel-pink","Steel-Teal","KSU-Purple","Stormcloud","Pale-green","Strawberry","Sugar-Plum","KU-Crimson","Dark-liver","Pale-taupe","Lawn-green","Super-pink","Pastel-red","Flavescent","Tango-pink","Lemon-lime","Taupe-gray","Black-bean","Peach-puff","Bondi-blue","Light-blue","Pearl-Aqua","Light-cyan","Teal-green","Periwinkle","Timberwolf","Light-gray","Light-pink","Alice-blue","Piggy-pink","Tufts-Blue","Pine-green","Tumbleweed","Congo-pink","Dark-taupe","Tuscan-red","Tuscan-tan","Debian-red","Pink-pearl","Deep-Green","Deep-lemon","Deep-lilac","Deep-mauve","Ultra-pink","Deep-peach","Cool-Black","Aquamarine","Magic-mint","USAFA-blue","Army-green","Copper-red","Vegas-gold","Queen-blue","Queen-pink","Deep-Taupe","Coquelicot","Cadet-blue","Raw-Sienna","Vista-blue","Denim-Blue","Razzmatazz","Warm-black","Waterspout","Coral-pink","Mardi-Gras","Cadet-grey","Coral-Reef","Wine-dregs","Winter-Sky","Han-purple","Wood-brown","Rich-black","Rich-lilac","Bright-ube","Heart-Gold","Lime-green"];
...
if (cluster.isMaster) {
    ...
    for (var i=0; i < nodesPerCore * require('os').cpus().length; i++) {
        workers[i] = cluster.fork({WORKER_INDEX:i, ROOM_NAME: serverNameList[i]});
    }
    ...
    server.listen(gamePort, function () {
        console.log('Room "' + ROOM_NAME + '" Worker ' + WORKER_INDEX + ' listening on ' + server.address().port)
    });
